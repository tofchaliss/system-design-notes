...
- [Transactions](concepts/transaction-concurrency.md#transactions)
- [Concurrency](concepts/transaction-concurrency.md#concurrency)
  - [Lost update problem (Write - write conflict)](concepts/transaction-concurrency.md#lost-update-problem-write---write-conflict)
    - [Solution using pessimistic locking](concepts/transaction-concurrency.md#solution-using-pessimistic-locking)
    - [Solution using optimistic locking + Version control](concepts/transaction-concurrency.md#solution-using-optimistic-locking-version-control)
  - [Dirty read problem (Write - read conflict)](concepts/transaction-concurrency.md#dirty-read-problem-write---read-conflict)
  - [Non-repeatable read problem (Read - write conflict)](concepts/transaction-concurrency.md#non-repeatable-read-problem-read---write-conflict)
  - [Phantom read problem (Read - read conflict)](concepts/transaction-concurrency.md#phantom-read-problem-read---read-conflict)
  - [Incorrect summary problem](concepts/transaction-concurrency.md#incorrect-summary-problem)
    - [Comparision between types of isolations](concepts/transaction-concurrency.md#comparision-between-types-of-isolations)
- [Serialization](concepts/transaction-concurrency.md#serialization)
- [Concurency Control](concepts/transaction-concurrency.md#concurency-control)
  - [2 Phase Locking](concepts/transaction-concurrency.md#2-phase-locking)
    - [Strict 2 Phase Locking](concepts/transaction-concurrency.md#strict-2-phase-locking)
    - [Rigourous 2 Phase Locking](concepts/transaction-concurrency.md#rigourous-2-phase-locking)
    - [Conservative 2 Phase Locking](concepts/transaction-concurrency.md#conservative-2-phase-locking)
    - [Use cases](concepts/transaction-concurrency.md#use-cases)
  - [Flow Graph based Locking (FGL)](concepts/transaction-concurrency.md#flow-graph-based-locking-fgl)
  - [Timestamp based Locking (TBL)](concepts/transaction-concurrency.md#timestamp-based-locking-tbl)
